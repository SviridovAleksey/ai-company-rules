...
ИИ и специалист работают совместно с MCP-сервером Confluence — изменения в MD отражаются в Confluence и наоборот.

**Область применения процесса:**
> Процесс описанный ниже (Фазы 1–4) применяется **как при создании нового проекта, так и при добавлении новой фичи** в существующий проект. Масштаб проработки пропорционален масштабу изменения, но цепочка ролей и ответственность за артефакты — неизменны.
...
### Фаза 2 — В течение первого квартала
